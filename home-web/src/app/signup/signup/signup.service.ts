...
export class SignUpService extends BackendService {
  public getEmailToken(email: string): Promise<void> {
    ...
    return this._client.get<void>(`${this.LoginAPIEndpoint}/emailTokens`, { params: params }).toPromise();
  }

  public postAccount(body: AccountPostBody): Promise<void> {
    return this._client.post<void>(`${this.LoginAPIEndpoint}/accounts`, body).toPromise();
  }
}
